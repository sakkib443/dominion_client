                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-3">
                        <select
                            ...
                            className="px-4 py-2.5 border border-gray-200 rounded-md focus:ring-2 focus:ring-[#0B4222] focus:border-transparent outline-none bg-white text-sm font-medium min-w-[140px]"
                        >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link
                                                    ...
                                                    className="p-2 bg-gray-50 hover:bg-white text-gray-500 hover:text-[#0B4222] border border-gray-100 hover:border-[#0B4222]/30 rounded-md transition-all shadow-sm"
                                                    title="View Profile"
                                                >
                                                    <FiEye size={18} />
                                                </Link>
