        ...
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-md border border-gray-200 shadow-sm">
                ...
                <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-[#0B4222] text-white rounded-md font-bold hover:bg-[#093519] transition-all shadow-md disabled:opacity-50"
                >
                    <FiSave size={20} />
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
                            <FiInfo className="text-[#0B4222]" size={18} />
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
                            <FiSettings className="text-[#0B4222]" size={18} />
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
                            <FiImage className="text-[#0B4222]" size={18} />
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                    />
                                    <div className={`w-10 h-5 rounded-full transition-colors ${formData.isFeatured ? 'bg-[#0B4222]' : 'bg-gray-200'}`}></div>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                    />
                                    <div className={`w-10 h-5 rounded-full transition-colors ${formData.showInMenu ? 'bg-[#0B4222]' : 'bg-gray-200'}`}></div>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                    />
                                    <div className={`w-10 h-5 rounded-full transition-colors ${formData.showInHome ? 'bg-[#0B4222]' : 'bg-gray-200'}`}></div>
...
const CategoryForm = () => {
    return (
        <Suspense fallback={<div className="p-20 text-center text-[#0B4222]">Initializing category form...</div>}>
            <CategoryFormInner />
        </Suspense>
    );
};
