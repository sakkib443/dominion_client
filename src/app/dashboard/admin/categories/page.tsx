        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-md border border-gray-200 shadow-sm">
                ...
                <Link
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-[#0B4222] text-white rounded-md font-semibold hover:bg-[#093519] transition-all shadow-md"
                >
                    <FiPlus size={20} />
                    Create Category
                </Link>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 rounded-md border border-gray-200 shadow-sm">
                <div className="relative w-full md:w-96">
                    ...
                    <input
                        ...
                        className="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-md outline-none focus:border-[#0B4222] focus:bg-white transition-all text-sm"
                        value={searchTerm}
            ...
            <div className="bg-white rounded-md border border-gray-200 shadow-sm overflow-hidden">
                {isLoading ? (
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <Link
                                                    ...
                                                    className="p-2 hover:bg-white hover:shadow-md rounded-md text-[#0B4222] transition-all border border-transparent hover:border-gray-100"
                                                    title="Edit"
                                                >
                                                    <FiEdit2 size={18} />
                                                </Link>
                    ...
                    <div className="p-20 text-center">
                        ...
                        <Link
                            href="/dashboard/admin/categories/new"
                            className="inline-flex items-center gap-2 mt-6 px-6 py-2.5 bg-[#0B4222] text-white rounded-xl font-bold hover:bg-[#093519] transition-all"
                        >
                            <FiPlus size={20} />
