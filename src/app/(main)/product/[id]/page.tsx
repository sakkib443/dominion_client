    ...
    return (
        <div className="bg-white min-h-screen font-['Poppins']">
            ...
            <div className="container mx-auto px-4 py-4 text-sm text-gray-500 flex items-center gap-2">
                <Link href="/" className="hover:text-[#0B4222]">🏠</Link>
                <span>&gt;</span>
                <Link href="/shop" className="hover:text-[#0B4222]">Categories</Link>
                <span>&gt;</span>
                <Link href="/shop/vegetables" className="hover:text-[#0B4222]">{product.category}</Link>
                <span>&gt;</span>
                <span className="text-[#0B4222]">{product.name}</span>
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                        ...
                        <div className="hidden md:flex flex-col gap-3">
                            ...
                            {product.images.map((img, idx) => (
                                <div
                                    ...
                                    className={`w-20 h-20 border rounded-lg cursor-pointer flex items-center justify-center p-2 transition-all ${selectedImage === idx ? 'border-[#0B4222]' : 'border-gray-200'}`}
                                >
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="bg-[#EDF2EE] text-[#0B4222] text-xs px-2.5 py-1 rounded font-medium">In Stock</span>
                        </div>
                        ...
                        <div className="border-y border-gray-100 py-6 mb-6 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex gap-2">
                                    <button className="w-8 h-8 rounded-full bg-[#0B4222] text-white flex items-center justify-center hover:opacity-90 transition-all"><FaFacebookF size={14} /></button>
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-8">
                            ...
                            <button className="flex-1 bg-[#0B4222] text-white rounded-full h-12 flex items-center justify-center gap-3 font-semibold hover:bg-[#009606] transition-all shadow-md">
                                Add to Cart <FiShoppingCart />
                            </button>
                            <button className="w-12 h-12 rounded-full bg-[#EDF2EE] text-[#0B4222] flex items-center justify-center hover:bg-[#0B4222] hover:text-white transition-all">
                                <FiHeart size={20} />
                            </button>
                        </div>
                    ...
                    <div className="flex justify-center border-b border-gray-100 gap-8 md:gap-16">
                        {['Descriptions', 'Additional Information', 'Customer Feedback'].map((tab) => (
                            <button
                                ...
                                className={`pb-4 text-sm md:text-base font-medium transition-all relative ${activeTab === tab.toLowerCase().split(' ')[0] ? 'text-gray-900 border-b-2 border-[#0B4222]' : 'text-gray-500 hover:text-gray-700'}`}
                            >
                                {tab}
                            </button>
                        ))}
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={idx} className="flex items-center gap-3 text-sm text-gray-600 font-medium">
                                        <div className="w-5 h-5 rounded-full bg-[#0B4222] flex items-center justify-center text-white">
                                            <FiCheckCircle size={12} className="fill-white text-[#0B4222]" />
                                        </div>
                                        {item}
                                    </li>
                                ))}
                        ...
                        <div className="lg:w-2/5">
                            <div className="relative rounded-2xl overflow-hidden mb-6 h-64 md:h-80">
                                ...
                                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                                    <button className="w-16 h-16 rounded-full bg-[#0B4222] text-white flex items-center justify-center hover:scale-110 transition-transform">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="border border-gray-100 rounded-xl p-5 flex items-center gap-4">
                                    <div className="bg-[#EDF2EE] w-12 h-12 rounded-lg flex items-center justify-center">
                                        <span className="text-[#0B4222] text-lg font-bold">64%</span>
                                    </div>
                                    <div>
                                ...
                                <div className="border border-gray-100 rounded-xl p-5 flex items-center gap-4">
                                    <div className="bg-[#EDF2EE] w-12 h-12 rounded-lg flex items-center justify-center">
                                        <span className="text-[#0B4222] text-lg">🌿</span>
                                    </div>
                                    <div>
