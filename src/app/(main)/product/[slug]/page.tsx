        ...
        <>
            <div style={{ background: '#fff', minHeight: '100vh' }}>
                <div className="container">
                    ...
                    <div style={{ paddingTop: '0px' }}>
                        <div className="pd-main-flex" style={{
                            ...
                            height: 'calc(clamp(300px, 32vw, 480px) + 60px)',
                        }}>
                            ...
                            <div className="pd-left-section" style={{
                                ...
                                <div style={{ display: 'flex', height: 'clamp(300px, 32vw, 480px)', overflow: 'visible' }}>
                                    ...
                                    {colorSwatches.length > 0 && (
                                        <div className="pd-color-col" style={{
                                            ...
                                            <span style={{ fontSize: '10px', fontWeight: 400, color: '#555', textTransform: 'capitalize', letterSpacing: '0', whiteSpace: 'nowrap' }}>{product.productType === 'multi-color' ? 'Multicolor' : 'Color'}</span>
                                ...
                                <div className="pd-action-bar" style={{
                                    ...
                                    <div
                                        ...
                                        onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = '#000'; e.currentTarget.querySelectorAll<HTMLElement>('button, span').forEach(el => { el.style.color = '#000'; }); }}
                                    >
                                        <button onClick={() => { if (product.stock === 0) return; setShowBuyNowModal(true); }} disabled={product.stock === 0} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', border: 'none', color: '#000', fontWeight: 700, fontSize: '11px', cursor: 'pointer', padding: '0 16px', height: '100%', letterSpacing: '0.4px', textTransform: 'uppercase', whiteSpace: 'nowrap', width: '100%' }}>
                                            BUY NOW
                                        </button>
                                    </div>
                                    {/* SEND INQUIRY */}
                                    <button onClick={() => setShowInquiryModal(true)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', border: '1.5px solid #000', color: '#000', fontWeight: 700, fontSize: '11px', cursor: 'pointer', padding: '0 14px', height: '100%', letterSpacing: '0.4px', textTransform: 'uppercase', borderRadius: '8px', whiteSpace: 'nowrap', transition: 'all 0.2s ease', flex: 1 }} onMouseEnter={(e) => { e.currentTarget.style.background = '#0B4222'; e.currentTarget.style.borderColor = '#0B4222'; e.currentTarget.style.color = '#fff'; }} onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = '#000'; e.currentTarget.style.color = '#000'; }}>
                                        SEND INQUIRY
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="pd-right-section" style={{
                                ...
                                >
                                    {/* Sticky Price + Product Details heading */}
                                    <div style={{
                                        position: 'sticky', top: '-2px', zIndex: 5,
                                        background: '#fff',
                                        ...
                                        <h3 style={{
                                            ...
                                            margin: '0 0 0 0', borderBottom: '1px solid #e5e7eb',
                                            paddingBottom: '6px'
                                        }}>
                                            Product Details:
                                        </h3>
                ...
                @media (max-width: 767px) {
                    ...
                    /* ── Main wrapper: remove fixed height, go column ── */
                    .pd-main-flex {
                    ...
                    /* ── Left section: full width, auto height, column layout ── */
                    .pd-left-section {
                    ...
                    /* Image area row inside left section — remove fixed height */
                    .pd-left-section > div:first-child {
                        height: auto !important;
                        flex-direction: column !important;
                        overflow: visible !important;
                    }

                    /* ── ORDER 1: Main image — full width square ── */
                    .pd-image-wrapper {
                        width: 100% !important;
                    ...
                    /* ── ORDER 2: Thumbnail strip — horizontal scrollable ── */
                    .pd-thumb-col {
                        width: 100% !important;
                        order: 2 !important;
                    ...
                    /* Inner scrollable container → horizontal row */
                    ...
                    /* Thumbnail buttons — slightly smaller on mobile */
                    .pd-thumb-col button {
                    ...
                    /* ── ORDER 3: Size swatches — horizontal wrap row ── */
                    .pd-size-col {
                        width: 100% !important;
                        order: 3 !important;
                        flex-direction: row !important;
                    ...
                    /* Inner swatch container → horizontal wrap */
                    ...
                    /* ── ORDER 4: Color swatches — horizontal wrap row ── */
                    .pd-color-col {
                        width: 100% !important;
                        order: 4 !important;
                        flex-direction: row !important;
                    ...
                    /* ── ORDER 5: Right section (price + details) — full width, auto height ── */
                    .pd-right-section {
                        flex: 0 0 100% !important;
                        max-width: 100% !important;
                        height: auto !important;
                    ...
                    /* Remove fixed scroll on right panel content */
                    .pd-right-scroll {
                    ...
                    /* Disable sticky price header — just flow normally */
                    .pd-right-section [style*="sticky"] {
                        position: static !important;
                    }
                    /* Hide up/down scroll arrows */
                    .pd-scroll-arrow { display: none !important; }

                    /* ── ORDER 6: Action bar — ADD TO CART + BUY NOW side by side, INQUIRY full width ── */
                    .pd-action-bar {
                        flex-wrap: wrap !important;
                        gap: 8px !important;
                        height: auto !important;
                    ...
                    /* ADD TO CART + BUY NOW → each 50% minus gap */
                    .pd-action-bar > div {
                        flex: 1 1 calc(50% - 4px) !important;
                        min-width: 0 !important;
                        height: 44px !important;
                    }
                    /* SEND INQUIRY → full width */
                    .pd-action-bar > button {
                        flex: 0 0 100% !important;
                        height: 44px !important;
                    }

                    /* ── ORDER 7: Info bar (Delivery/Payment/Terms) ── */
                    .pd-info-bar {
                        height: auto !important;
                        flex-wrap: wrap !important;
                    ...
                    /* ── Stats row — tighter gap, wraps properly ── */
                    .pd-stats-row {
                        gap: 10px !important;
                        flex-wrap: wrap !important;
